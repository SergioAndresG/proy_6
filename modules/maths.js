...
const conversionDatos = data => {
    ...
    if (data === '' || data === null || data === undifined || data.length === 0) {
...
math.invertitArreglo = invertitArreglo;
